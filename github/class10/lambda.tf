...
resource "aws_iam_role" "lambda_role" {
  name = "${var.prefix}-${var.environment}-iam-key-rotation-role"
...
resource "aws_iam_policy" "lambda_policy" {
  name        = "${var.prefix}-${var.environment}-iam-key-rotation-policy"
...
resource "aws_lambda_function" "my_lambda_function" {
    function_name    = "${var.prefix}-${var.environment}-iam-key-rotation"
